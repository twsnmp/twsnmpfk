export namespace backend {
	...
	export class SyslogAnomalyItem {
	    Time: number;
	    Host: string;
	    Tag: string;
	    Severity: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new SyslogAnomalyItem(source);
	    }
	...
	export class SyslogAnomalyResponse {
	    DurationMs: number;
	    Logs: SyslogAnomalyItem[];
	
	    static createFrom(source: any = {}) {
	        return new SyslogAnomalyResponse(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.DurationMs = source["DurationMs"];
	        this.Logs = this.convertValues(source["Logs"], SyslogAnomalyItem);
	    }
...
export namespace datastore {
	...
	export class DrawItemEnt {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.FormattedText = source["FormattedText"];
	    }
	}
...
export namespace main {
	...
	export class ImportIconEnt {
	    Icons: datastore.IconEnt[];
	    Errors: string[];
	
	    static createFrom(source: any = {}) {
	        return new ImportIconEnt(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.Icons = this.convertValues(source["Icons"], datastore.IconEnt);
	        this.Errors = source["Errors"];
	    }
