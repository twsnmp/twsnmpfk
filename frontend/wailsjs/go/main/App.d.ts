...
export function AnalyzeSigmaLogs(arg1:Array<datastore.SyslogEnt>,arg2:Array<string>,arg3:Array<string>):Promise<main.SigmaReportResult>;
...
export function CalculateSyslogAnomaly(arg1:Array<datastore.SyslogEnt>,arg2:string,arg3:string):Promise<backend.SyslogAnomalyResponse>;
...
export function GetSigmaPacks():Promise<Array<sigma.SigmaPackInfo>>;
